...
import type { Certificate, PatchedCertificate } from "../models/index";
import {
  CertificateFromJSON,
  CertificateToJSON,
...
export class CertificateApi extends runtime.BaseAPI {
  /**
   */
  async certificateCreateRaw(
    requestParameters: CertificateCreateRequest,
  ...
  async certificateCreate(
    ...
    const response = await this.certificateCreateRaw(
      requestParameters,
      initOverrides
    );
  ...
  /**
   */
  async certificateDestroyRaw(
    requestParameters: CertificateDestroyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    const response = await this.request(
      {
        path: `/api/certificate/{id}/`.replace(
          `{${"id"}}`,
  ...
  /**
   */
  async certificateListRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<Certificate>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(CertificateFromJSON)
    );
  }
  ...
  /**
   */
  async certificatePartialUpdateRaw(
    requestParameters: CertificatePartialUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Certificate>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async certificatePartialUpdate(
    requestParameters: CertificatePartialUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Certificate> {
    const response = await this.certificatePartialUpdateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async certificateRetrieveRaw(
    requestParameters: CertificateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Certificate>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async certificateRetrieve(
    requestParameters: CertificateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Certificate> {
    const response = await this.certificateRetrieveRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async certificateUpdateRaw(
    requestParameters: CertificateUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Certificate>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async certificateUpdate(
    requestParameters: CertificateUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Certificate> {
    const response = await this.certificateUpdateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async certificateUserCertificatesRetrieveRaw(
    requestParameters: CertificateUserCertificatesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Certificate>> {
    ...
    const response = await this.request(
      {
        path: `/api/certificate/{user_id}/user-certificates/`.replace(
          `{${"user_id"}}`,
  ...
  /**
   */
  async certificateUserCertificatesRetrieve(
    requestParameters: CertificateUserCertificatesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Certificate> {
    const response = await this.certificateUserCertificatesRetrieveRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
